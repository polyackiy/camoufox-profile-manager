...
Порты публикуются только на loopback. Для запуска настоящих браузеров внутри
контейнера нужен виртуальный дисплей; управление профилями и интерфейс работают
как есть.
...
├── cli.py              команда camoufox-pm
├── config.py           настройки из переменных окружения
├── core/
│   ├── models.py            профили, группы, настройки браузера
...
│   ├── fingerprint_store.py закрепление и пресеты реальных устройств
│   └── profile_archive.py   экспорт и импорт профиля целиком
└── api/                роуты, модели запросов и ответов, middleware
