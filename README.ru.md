...
> **Статус:** `v0.2.0`. Ядро работает и покрыто 361 тестом, 20 из которых гоняют
> настоящий браузер. REST API версионирован как `/api/v1` и имеет письменный
> [контракт стабильности](docs/api.md#stability-contract); до `1.0` возможны
> шероховатости в остальном.
